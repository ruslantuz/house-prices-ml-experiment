...
def cross_validate_scaled_log_target():
    ...
    if fold3_data:
        print("\nFold 3 Diagnosis - Top 3 Largest Absolute Errors:")
        print("-" * 80)
        ...
        # Print top 3
        for idx, row in fold3_df.head(3).iterrows():
...
if __name__ == "__main__":
    cross_validate_scaled_log_target()
